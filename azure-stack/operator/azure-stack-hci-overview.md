...
Azure Stack HCI je součástí řady rozbočovačů Azure a Azure Stack pomocí stejného softwaru definovaného pro výpočetní prostředky, úložiště a sítě jako centra pro Azure Stack. Tady je stručný přehled různých řešení (Další informace najdete v tématu [porovnání ekosystému centra Azure Stack](compare-azure-azure-stack.md)):
...
### <a name="when-to-use-azure-stack-hci"></a>Kdy použít Azure Stack HCI
