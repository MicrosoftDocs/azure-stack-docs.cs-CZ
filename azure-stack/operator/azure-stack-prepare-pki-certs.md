...
8.  Zkontrolujte výstup:
    ...
    ```
    > [!NOTE]
    > Pro další použití použijte příkaz Get-Help ConvertTo-AzsPFX-Full pro další použití, například zakázání ověřování nebo filtrování pro různé formáty certifikátů.
