---
title: Zpráva k vydání verze Azure Stack – aktualizace zabezpečení. 1906 | Dokumentace Microsoftu
description: Další informace o aktualizacích zabezpečení. 1906 pro službu Azure Stack.
...
ms.locfileid: "67419832"
---
# <a name="azure-stack-security-updates"></a>Aktualizace zabezpečení Azure stacku

Tento článek obsahuje seznam všech aktualizací zabezpečení v poslední čtyři aktualizace služby Azure Stack. Tyto informace slouží jenom k referenčním účelům.

## <a name="1906-update"></a>aktualizace. 1906

Tato aktualizace služby Azure Stack nezahrnuje aktualizace zabezpečení pro příslušný operační systém, který je hostitelem služby Azure Stack.

## <a name="1905-update"></a>aktualizace 1905

Aktualizace 1905 nainstaluje následující aktualizace:
...
Z důvodu povahy kumulativní aktualizace Windows tato aktualizace obsahuje také datových částí zabezpečení předchozích měsíců. Seznam CVEs výše odpovídá zabezpečení datovou část březen, duben a. května 2019.
Další informace o těchto ohrožení zabezpečení, klikněte na výše uvedené odkazy nebo najdete v článcích znalostní báze Microsoft [4499177](https://support.microsoft.com/en-us/help/4499177).

## <a name="1904-update"></a>aktualizace 1904

Tato aktualizace služby Azure Stack nezahrnuje aktualizace zabezpečení pro příslušný operační systém, který je hostitelem služby Azure Stack.

## <a name="1903-update"></a>aktualizace 1903

Tato aktualizace služby Azure Stack nezahrnuje aktualizace zabezpečení pro příslušný operační systém, který je hostitelem služby Azure Stack.  

## <a name="1902-update"></a>aktualizace 1902

Aktualizace 1902 nainstaluje následující aktualizace:  
