...
- [Odeslat protokoly nyní](./diagnostic-log-collection.md#send-logs-now-with-the-administrator-portal): jako časový rámec pro shromažďování protokolů můžete zvolit konkrétní posuvné okno.
