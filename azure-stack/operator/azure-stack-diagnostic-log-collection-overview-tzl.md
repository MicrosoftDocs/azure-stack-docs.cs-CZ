...
>[!NOTE]
>Centrum Azure Stack musí být zaregistrované a musí mít připojení k Internetu, aby bylo možné používat shromažďování protokolů diagnostiky. Pokud není zaregistrované centrum Azure Stack, [pomocí privilegovaného koncového bodu (PEP)](azure-stack-get-azurestacklog.md) sdílejte protokoly.
...
Protokoly shromážděné pomocí **Odeslat protokoly se teď odesílají** do úložiště spravovaného a řízeného Microsoftem. K těmto protokolům přistupoval Microsoft v kontextu případu podpory a ke zlepšení stavu centra Azure Stack.
