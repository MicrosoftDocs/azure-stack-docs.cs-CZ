...
6. Zkontrolujte seznam doplňkových plánů, který je součástí nabídky, a ověřte, že je uvedený nový plán doplňku.
    ...
    ![Kontrola seznamu doplňkových plánů na portálu pro správu Azure Stack](media/create-add-on-plan/add-on4.png "Vytvořit plán doplňku")] (Media/Create-Add-on-Plan/Add-on4lg. png # Lightbox)
::: moniker-end
