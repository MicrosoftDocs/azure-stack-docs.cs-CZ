...
- [Zálohování aplikace v Azure](/azure/app-service/manage-backup)
- [Co je SQL Server na virtuálních počítačích Azure? Systému](/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview)
...
![Snímek obrazovky, který ukazuje, jak spustit zálohování na vyžádání.](media/azure-stack-backup/scheduled-backup.png)
