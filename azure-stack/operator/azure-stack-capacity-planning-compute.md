...
Azure Stack centrum používá při umísťování virtuálních počítačů dva předpoklady. Je k dispozici dostatek paměti na hostiteli pro tento typ virtuálního počítače? A dva jsou virtuální počítače součástí skupiny [dostupnosti](https://docs.microsoft.com/azure/virtual-machines/windows/manage-availability) nebo se jedná o [sady škálování virtuálních počítačů](https://docs.microsoft.com/azure/virtual-machine-scale-sets/overview)?
