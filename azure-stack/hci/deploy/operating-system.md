...
Další informace o použití nástroje VMM k úplnému nasazení operačního systému najdete v tématu [zřízení hostitele nebo clusteru Hyper-V z holých počítačů](/system-center/vmm/hyper-v-bare-metal?view=sc-vmm-2019).
