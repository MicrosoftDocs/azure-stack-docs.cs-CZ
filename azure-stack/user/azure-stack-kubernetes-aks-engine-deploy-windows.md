...
1. Vytvořte ve svém Azure Stack virtuální počítač s Windows. Pokyny najdete v tématu [rychlý Start: Vytvořte virtuální počítač s Windows serverem pomocí Azure Stackového portálu](https://docs.microsoft.com/azure-stack/user/azure-stack-quick-windows-portal).
