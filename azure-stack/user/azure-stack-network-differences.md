...
| Service | Funkce | Azure (Global) | Centrum Azure Stack |
|--------------------------|----------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| DNS | Víceklientské DNS | Podporuje se | Zatím nepodporováno |
|  | DNS AAAA records | Podporuje se | Nepodporuje se |
...
| Virtuální síť | Partnerské vztahy virtuálních sítí | Propojit dvě virtuální sítě ve stejné oblasti prostřednictvím páteřní sítě Azure. | Zatím nepodporováno |
...
| Network Security Groups (Skupiny zabezpečení sítě) | Rozšířená pravidla zabezpečení | Podporuje se | Zatím se nepodporuje. |
...
| Load Balancer | Skladová položka | Podporují se základní a standardní nástroje pro vyrovnávání zatížení. | Podporuje se jenom základní Load Balancer.<br>Vlastnost SKU není podporována.<br>/Path/nástroje pro vyrovnávání zatížení základního SKU nemůže mít více než 5 konfigurací front-endové IP adresy.  |
...
|  | Statická adresa MAC | Nepodporuje se | Nepodporuje se. Každý systém Azure Stack hub používá stejný fond adres MAC. |
