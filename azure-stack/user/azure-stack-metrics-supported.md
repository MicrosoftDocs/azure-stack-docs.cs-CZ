...
description: Přečtěte si o podporovaných metrikách pro Azure Monitor v Azure Stack.
...
ms.locfileid: "73955680"
---
# <a name="supported-metrics-for-azure-monitor-on-azure-stack"></a>Podporované metriky pro Azure Monitor v Azure Stack

*Platí pro: Azure Stack integrovaných systémů*

Metriky ze služby Azure monitor v Azure Stack jsou načteny stejným způsobem jako v globálním Azure. Můžete vytvořit své míry na portálu, získat je z REST API nebo je pomocí PowerShellu nebo rozhraní příkazového řádku dotazovat.

V následujících tabulkách jsou uvedeny metriky dostupné s kanálem metriky Azure Monitor v Azure Stack. K dotazování a přístupu k těmto metrikám použijte verzi rozhraní API verze **2018-01-01** API. Další informace o profilech rozhraní API a Azure Stack najdete v tématu [Správa profilů verzí rozhraní API v Azure Stack](azure-stack-version-profiles.md).
...
| Metrika | Zobrazovaný název metriky | Jednotka | Typ agregace | Popis | Dimenze |
|--------|---------------------|------|------------------|-------------|------------|
| BlobCapacity | Kapacita objektu BLOB | Psaný | Celkem | Velikost úložiště využitá Blob service účtu úložiště v bajtech | blobType |
