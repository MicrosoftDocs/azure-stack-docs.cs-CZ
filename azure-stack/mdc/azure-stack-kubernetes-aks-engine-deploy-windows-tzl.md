---
title: Nasazení modulu AKS v centru Azure Stack (Windows)
description: Naučte se, jak pomocí počítače s Windows v centru Azure Stack hostovat modul AKS, abyste mohli nasadit a spravovat cluster Kubernetes v MDC.
author: mattbriggs
ms.topic: article
ms.date: 10/26/2020
ms.author: mabrigg
...
ms.locfileid: "97598618"
---
# <a name="install-the-aks-engine-on-windows-in-azure-stack-hub---modular-data-center-mdc"></a>Instalace modulu AKS ve Windows v centru pro Azure Stack hub – modulární datové centrum (MDC)
...
- Pokud klientský počítač by měl být v případě havárie obnovitelný.
- Jak se připojíte ke klientskému počítači a jak bude počítač pracovat s clusterem.
