---
title: Set-CloudAdminUserPassword privilegovaného koncového bodu pro centrum Azure Stack
description: Reference pro Azure Stack s privilegovaným koncovým bodem prostředí PowerShell – set-CloudAdminUserPassword
author: mattbriggs
ms.topic: reference
ms.date: 04/27/2020
ms.author: mabrigg
...
### <a name="-newpassword"></a>-Nové_heslo
