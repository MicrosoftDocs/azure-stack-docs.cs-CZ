...
| Azure DevOps Services | Zaregistrovat | Rychle nastavte průběžnou integraci pro sestavování, testování a nasazování. Další informace najdete v tématu [registrace, přihlášení do Azure DevOps](/azure/devops/user-guide/sign-up-invite-teammates?view=azure-devops). |
...
- Sledujte, jak se tento model používá, a to prostřednictvím [dynamického škálování aplikací mezi datovými centry a veřejným cloudem](https://www.youtube.com/watch?v=2lw8zOpJTn0) .
